...
(define (yoda words)
  "TODO: Implement"
  (append (list (car (reverse words))) (reverse (cdr (reverse words))))
  )
...
(define (pig-latin word)
  "TODO: Implement"
  (append (cdr word) (append (list (car word)) (list 'a 'y)))
  )
...
(define (quad-roots a b c)
  ...
  (list (/ (- (* -1. b) (sqrt (discr a b c))) (* 2. a)) (/ (+ (* -1. b) (sqrt (discr a b c))) (* 2. a)))
  )
...
(define (rotate c)
  "TODO: Implement"
  (define (comp c)
    (list (car c) (car (reverse c)))
   )
  (define (rcomp c)
    (list (car (reverse c)) (car c))
   )
  (list (comp c) (append (list (car (rcomp c))) (list (* -1 (car (comp c))))) (append (list (* -1 (car (comp c)))) (list (* -1 (car (rcomp c))))) (append (list (* -1 (car (rcomp c)))) (list (car (comp c)))))
  )
